...
<html lang="es">    
    ...
    <body style="background:#1B5B94;">
    <div class="container overflow-hidden" style="flex-wrap:wrap; padding: 50px 35px 50px 35px;">
    <div class="form-outer">
        ...
        <div class="container text-white text-center " id="nuevo">
            <hr width=100% size=5 style=" color:#f65b0d;">
            <h1 style="color:#1B5B94">Aplicar Estudio</h1>
            <hr width=100% size=5 style=" color:#f65b0d;">
            <div class="notacondition">
                <center>
                    <p>Completa este corto formulario, obtén tu preaprobación Rent10 y aplica a tantas propiedades en renta como necesites con una sola aplicación. Tiempo estimado para completar: 4 minutos</p>
                </center>
            </div>
        </div>
        <br>
